...
(function(global, undefined) {
    ...
    var emit = xxx.emit = function(name, data) {
        var list = events[name],
            fn
    ...
    var loaderScript = doc.getElementById("xxxnode") ||
...
(function(global) {
    'use strict';
    var xxxjs = global.xxxjs;
    var Module = xxxjs.Module
    var FETCHING = Module.STATUS.FETCHING

    var data = xxxjs.settings;
    ...
    // For test
    if (data.test) {
        var test = xxxjs.test || (xxxjs.test = {})
